...
// I had no idea I could/should do everything from inside the component.

export default async function Page() {
  let images: string[];

  /* FLASH IDEA
  Making a listen to shift between images source on the deployed version... Or rather...
  ...
  */
  ...
  const directory = "./public/images9";
  ...
  // console.log(images);
  /* if images param = 0 imagesDynamized(10) */
